...
const call = () =>
    DELETE(new Request('http://t/api/admin/users/mfa?userId=victim', {
        method: 'DELETE',
    }) as never)

describe('/api/admin/users/mfa', () => {
    beforeEach(() => {
        vi.clearAllMocks()
    ...
    it('nekar en stationschef', async () => {
    ...
    it('släpper igenom en VO-chef ända fram till det privilegierade arbetet', async () => {
        signedIn('vo_chief')
