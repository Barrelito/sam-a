...
export async function GET(request: NextRequest, { params }: RouteParams) {
    ...
    // Annual cycle tasks are ordinary rows; expose their template's action_link
    const { annual_cycle_item, ...taskFields } = task

    return NextResponse.json({
        task: {
            ...taskFields,
            is_annual_cycle: !!taskFields.annual_cycle_item_id,
