...
import { Ambulance, Mail, Lock, Loader2, AlertCircle, ShieldCheck } from "lucide-react"
...
export default function LoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        // Redirect will happen via middleware or we force it here
            ...
            <Card className="w-full max-w-md">
                <CardHeader className="text-center">
                    ...
                    <CardDescription>
                        ...
                        {mode === 'mfa' && 'Ange koden från din authenticator-app'}
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    {error && (
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            required
                                            autoFocus
                                            className="w-full pl-10 pr-4 py-2 border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary text-center tracking-widest text-lg"
                                        />
                                    </div>
                                </div>
                            )}
                    ...
                    <div className="mt-6 text-center text-sm">
                        ...
                        {mode === 'mfa' && (
                            <button
                                onClick={() => { setMode('login'); setError(null); setMessage(null); setPassword('') }}
                                className="text-primary hover:underline font-medium"
                            >
                                Tillbaka till inloggning
                            </button>
